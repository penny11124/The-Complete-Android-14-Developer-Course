package com.techmania.movieproapp.adapters;
...
import com.techmania.movieproapp.databinding.MovieListItemBinding;
import com.techmania.movieproapp.view.MovieActivity;
            ...
            movieListItemBinding.getRoot().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(position != RecyclerView.NO_POSITION) {
                        Movie selectMovie = movieArrayList.get(position);
