...
public class AddJournalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextThought = findViewById(R.id.editTextPostDescription);
        textViewCurrentUser = findViewById(R.id.textViewPostUserName);

        imageView = findViewById(R.id.imageViewPost);
        buttonSave = findViewById(R.id.buttonPostSaveJournal);
        buttonAddPhoto = findViewById(R.id.buttonPostCamera);
    ...
    private void SaveJournal() {
        ...
        final String thoughts = editTextThought.getText().toString().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_CODE && resultCode == RESULT_OK) {
            if(data != null) {
                imageUri = data.getData(); //Get the actual image path
